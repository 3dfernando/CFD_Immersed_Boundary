...
public:
	...
	static void Setup_Interface::LoadBodyAndTrajectory(std::string file, int* ns, double* ds, double** xBody, double** yBody, double* xCenter, double* yCenter, double** xTraj, double** yTraj);
};
